...
if(add_awgn)
    ...
    fileName = sprintf('Massive_MU_MIMO_M%s_K%s_Np%s_BER_comparison_%s_mp_ls_equalization_ls_v7.fig',m_rx_antennas,m_tx_antennas,n_pilots,timeStamp);
    savefig(figura,fileName); clear figura
    
    % Save workspace to MAT-file.
    fileName = sprintf('Massive_MU_MIMO_M%s_K%s_Np%s_BER_comparison_%s_mp_ls_equalization_ls_v7.mat',m_rx_antennas,m_tx_antennas,n_pilots,timeStamp);
    save(fileName);
end