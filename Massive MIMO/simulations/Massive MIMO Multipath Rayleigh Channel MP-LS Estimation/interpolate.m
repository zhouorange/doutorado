...
if(strcmp(method,'linear'))
    H_interpolated = interp1(pilot_loc,H_est,1:Nfft,'linear');
elseif(strcmp(method,'spline'))
    H_interpolated = interp1(pilot_loc,H_est,1:Nfft,'spline');
elseif(strcmp(method,'pchip'))
    H_interpolated = interp1(pilot_loc,H_est,1:Nfft,'pchip');
elseif(strcmp(method,'cubic'))
    H_interpolated = interp1(pilot_loc,H_est,1:Nfft,'cubic');
end