...
fileName = sprintf('M_MU_MIMO_M%s_K%s_flatfading_zc_est_chann_v1_%s_.fig',m_rx_antennas,m_tx_antennas,timeStamp);
savefig(h,fileName);

% Save workspace to MAT-file.
clear h
fileName = sprintf('M_MU_MIMO_M%s_K%s_flatfading_zc_est_chann_v1_%s.mat',m_rx_antennas,m_tx_antennas,timeStamp);
save(fileName);
