...
fprintf(1,'h110: %s - pdp_freq_adjusted(%d): %s - error: %f\n',num2str(H(1,1,1)),position(1),num2str(pdp_freq_adjusted(position(1))),abs(H(1,1,1)-pdp_freq_adjusted(position(1))));
fprintf(1,'h120: %s - pdp_freq_adjusted(%d): %s - error: %f\n',num2str(H(1,2,1)),position(2),num2str(pdp_freq_adjusted(position(2))),abs(H(1,2,1)-pdp_freq_adjusted(position(2))));
fprintf(1,'h130: %s - pdp_freq_adjusted(%d): %s - error: %f\n',num2str(H(1,3,1)),position(3),num2str(pdp_freq_adjusted(position(3))),abs(H(1,3,1)-pdp_freq_adjusted(position(3))));

fprintf(1,'h111: %s - pdp_freq_adjusted(%d): %s - error: %f\n',num2str(H(1,1,2)),(position(1)+delay_zcorr1),num2str(pdp_freq_adjusted(position(1)+delay_zcorr1)),abs(H(1,1,2)-pdp_freq_adjusted(position(1)+delay_zcorr1)));
fprintf(1,'h121: %s - pdp_freq_adjusted(%d): %s - error: %f\n',num2str(H(1,2,2)),(position(2)+delay_zcorr1),num2str(pdp_freq_adjusted(position(2)+delay_zcorr1)),abs(H(1,2,2)-pdp_freq_adjusted(position(2)+delay_zcorr1)));
fprintf(1,'h131: %s - pdp_freq_adjusted(%d): %s - error: %f\n',num2str(H(1,3,2)),(position(3)+delay_zcorr1),num2str(pdp_freq_adjusted(position(3)+delay_zcorr1)),abs(H(1,3,2)-pdp_freq_adjusted(position(3)+delay_zcorr1)));
