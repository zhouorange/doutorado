...
load('.\M_MU_MIMO_M_100_K_10_multFad_woLargeScl_rake_est_chann_20150427T160514.mat');
...
set(gca,'yscale','log','xlim',[EbNoVec(EbNoVecidx(1))-0.01, EbNoVec(EbNoVecidx(end))],'ylim',[2e-8 0.2]);
