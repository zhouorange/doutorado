...
load('.\Massive_MU_MIMO_M_1000_K_10_multipath_fading_various_detectors_without_large_scale_20150327T112136.mat');
...
set(gca,'yscale','log','xlim',[EbNoVec(EbNoVecidx(1))-0.01, EbNoVec(EbNoVecidx(end))],'ylim',[1e-8 7.3e-5]);
xlabel('SINR [dB]','FontSize',FontSize,'FontName','Times New Roman');
