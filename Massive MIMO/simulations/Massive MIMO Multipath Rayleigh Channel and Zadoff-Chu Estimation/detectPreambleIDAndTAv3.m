...
function [ID, TA, H_estimated] = detectPreambleIDAndTAv3(rx, M, K, numPaths, totalNumPaths, pos, H)
...
for np_idx=1:1:numPaths
    ...
    error2 = error2 + sum(sum((error_matrix(:,:,np_idx))));
end
error2 = error2 / totalNumPaths;
