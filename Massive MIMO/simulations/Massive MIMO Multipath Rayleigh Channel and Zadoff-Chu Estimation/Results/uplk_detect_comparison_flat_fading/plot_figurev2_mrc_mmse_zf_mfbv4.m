...
load('.\Massive_MU_MIMO_M_50_K_10_flat_fading_various_detectors_20150208T163418.mat');
...
xlabel('Eb/No [dB]','FontSize',FontSize,'FontName','Times New Roman');
...
for k_idx=1:1:length(K)
    ...
    for m_idx=1:1:length(M)
        ...
        for eb_no_idx = 1:length(desiredEnNo)
            ...
            % Plot results
            semilogy(EbNoVec(idx1:idx), BER_MFB(m_idx,idx1:idx), 'r-','LineWidth',2,'MarkerSize',12,'MarkerEdgeColor','r','MarkerFaceColor','w');
            semilogy(EbNoVec(idx1:idx), BER_MMSE_LE(m_idx,idx1:idx), 'bs-','LineWidth',0.5,'MarkerSize',12,'MarkerEdgeColor','b','MarkerFaceColor','w');
            semilogy(EbNoVec(idx1:idx), BER_ZF_LE(m_idx,idx1:idx), 'kx','LineWidth',0.5,'MarkerSize',12,'MarkerEdgeColor','k','MarkerFaceColor','w');
            semilogy(EbNoVec(idx1:idx), BER_MRC(m_idx,idx1:idx), 'go-','LineWidth',0.5,'MarkerSize',12,'MarkerEdgeColor','g','MarkerFaceColor','w');
