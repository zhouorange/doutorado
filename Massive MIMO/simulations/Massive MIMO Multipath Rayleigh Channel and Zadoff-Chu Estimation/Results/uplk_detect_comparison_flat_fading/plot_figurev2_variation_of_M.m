...
%load('C:\Users\felipep\Dropbox\Doutorado\Massive MIMO\simulations\uplink_detection_comparison_flat_fading_results\Massive_MU_MIMO_M_10_50_100_K_2_flat_fading.mat')
%load('C:\Users\felipep\Dropbox\Doutorado\Massive MIMO\simulations\uplink_detection_comparison_flat_fading_results\Massive_MU_MIMO_M_50_100_250_K_10_flat_fading.mat');
load('C:\Users\felipep\Dropbox\Doutorado\Massive MIMO\simulations\uplink_detection_comparison_flat_fading_results\Massive_MU_MIMO_M_50_K_10_flat_fading_various_detectors_20150208T163418.mat');
...
set(gca,'yscale','log','xlim',[EbNoVec(1)-0.01, EbNoVec(end)],'ylim',[0.9e-5 1e-1]);
...
for k_idx=1:1:length(K)
    ...
    for m_idx=1:1:length(M)
        ...
        semilogy(EbNoVec(1:idx), BER_MRC(m_idx,1:idx), 'r-','LineWidth',1,'MarkerFaceColor','white','MarkerSize',8);
        semilogy(EbNoVec(1:idx), BER_MFB(m_idx,1:idx), 'k-','LineWidth',1,'MarkerFaceColor','white','MarkerSize',8);
