...
M = 16; %9                                         % Number of pilots. Length of the training sequence.
...
while(error_cse_cosamp>1e-100)
    ...
    H = Fl*h(1:NCP); % H is the FFT of the channel H computed at the pilot's frequencies.
