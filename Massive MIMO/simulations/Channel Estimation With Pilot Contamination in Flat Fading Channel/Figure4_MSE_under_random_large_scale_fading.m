...
prop_error_hat1_vec = zeros(1,length(SNR));
prop_error_hat2_vec = zeros(1,length(SNR));
for snr_idx=1:1:length(SNR)
    
    for numIter = 0:1:NUM_ITER-1
        ...
        rand_value = randn(1);
        beta111_hat1 = abs(beta111*(1 + sqrt(0.1)*rand_value));
        beta111_hat2 = abs(beta111*(1 + sqrt(0.01)*rand_value));
        ...
        Z11_prop_hat1 = M*beta111_hat1*Z11_ls/((Z11_ls')*(Z11_ls));
        prop_error_hat1_vec(snr_idx) = prop_error_hat1_vec(snr_idx) + ((Z11_prop_hat1'-Gil(:,1,1)')*(Z11_prop_hat1-Gil(:,1,1)));
               
        Z11_prop_hat2 = M*beta111_hat2*Z11_ls/((Z11_ls')*(Z11_ls));
        prop_error_hat2_vec(snr_idx) = prop_error_hat2_vec(snr_idx) + ((Z11_prop_hat2'-Gil(:,1,1)')*(Z11_prop_hat2-Gil(:,1,1)));
    ...
    prop_error_hat1_vec(snr_idx) = prop_error_hat1_vec(snr_idx)./(M * NUM_ITER);
    prop_error_hat2_vec(snr_idx) = prop_error_hat2_vec(snr_idx)./(M * NUM_ITER);
