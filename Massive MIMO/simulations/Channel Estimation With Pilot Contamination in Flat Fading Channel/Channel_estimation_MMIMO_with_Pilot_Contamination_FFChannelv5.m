...
fileName = sprintf('flat_channel_estimation_mse_vs_tx_snr_M%d_K%d_L%d_N%d_v5_%s.fig',M,K,L,N,timeStamp);
savefig(fdee_figure,fileName);

% Save workspace to .mat file.
clear fdee_figure
fileName = sprintf('flat_channel_estimation_mse_vs_tx_snr_M%d_K%d_L%d_N%d_v5_%s.mat',M,K,L,N,timeStamp);
save(fileName);
