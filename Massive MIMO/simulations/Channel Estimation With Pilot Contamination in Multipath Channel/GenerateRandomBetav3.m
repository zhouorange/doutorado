function [distances, angles, beta_i, beta11k, beta_sum] = GenerateRandomBetav3(L,K,cellRadius,cellHole,sshadow,gamma,k_idx)
...
beta_sum = 0;
for l_idx=1:1:L
    beta_sum = beta_sum + beta_i(l_idx,k_idx);
end
