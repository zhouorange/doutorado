...
fileName = sprintf('channel_estimation_mse_vs_num_antennas_K%d_P%d_L%d_N%d_v2_%s.fig',K,P,L,N,timeStamp);
savefig(fdee_figure,fileName);

% Save workspace to .mat file.
clear fdee_figure
fileName = sprintf('channel_estimation_mse_vs_num_antennas_K%d_P%d_L%d_N%d_v2_%s.mat',K,P,L,N,timeStamp);
save(fileName);
