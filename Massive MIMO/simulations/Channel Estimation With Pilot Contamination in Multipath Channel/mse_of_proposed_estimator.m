...
for kk=1:1:numIter
    ...
    %trace_res = trace(Z11_ls'*Z11_ls);   
    %trace_res_sqr = trace_res_sqr + trace_res*trace_res;
    
    %var_b(kk) = trace(Z11_ls'*Z11_ls);
    
    sqr_matrix = Z11_ls'*Z11_ls;
    
    trace_res = trace_res + (sqr_matrix./(trace(sqr_matrix).^2));
    
end

trace_res/numIter

%trace_res_sqr/numIter
