...
SNR = -15:1:10; %-24:2:6;%-12:2:20;           % Signal-to-noise ratio in dB.
...
fileName = sprintf('channel_estimation_mse_vs_tx_snr_M%d_K%d_P%d_L%d_N%d_v12_%s.fig',M,K,P,L,N,timeStamp);
savefig(fdee_figure,fileName);

% Save workspace to .mat file.
clear fdee_figure
fileName = sprintf('channel_estimation_mse_vs_tx_snr_M%d_K%d_P%d_L%d_N%d_v12_%s.mat',M,K,P,L,N,timeStamp);
save(fileName);
