...
M = 90;%86;%30; %85;                % Number of antennas.
...
fdee_figure = figure;
semilogy(a,theoretical_mmse_error,'--r');
hold on;
semilogy(a,real(mmse_error_vec),'r*','MarkerSize',7);
semilogy(a,theoretical_ls_error,'--b','MarkerSize',7);
semilogy(a,real(ls_error_vec),'b*','MarkerSize',7);
semilogy(a,real(prop_1_ana_error_vec),'--k','MarkerSize',7);
semilogy(a,real(prop_1_sim_error_vec),'k*','MarkerSize',7);
semilogy(a,real(prop_2_ana_error_vec),'--g','MarkerSize',7);
semilogy(a,real(prop_2_sim_error_vec),'g*','MarkerSize',7);
semilogy(a,real(prop_3_ana_error_vec),'--m','MarkerSize',7);
semilogy(a,real(prop_3_sim_error_vec),'m*','MarkerSize',7);
semilogy(a,real(prop_4_ana_error_vec),'--c','MarkerSize',7);
semilogy(a,real(prop_4_sim_error_vec),'c*','MarkerSize',7);
hold off
grid on;
...
fileName = sprintf('channel_estimation_mse_vs_tx_snr_M%d_K%d_P%d_L%d_N%d_v15_%s.fig',M,K,P,L,N,timeStamp);
savefig(fdee_figure,fileName);

% Save workspace to .mat file.
clear fdee_figure
fileName = sprintf('channel_estimation_mse_vs_tx_snr_M%d_K%d_P%d_L%d_N%d_v15_%s.mat',M,K,P,L,N,timeStamp);
save(fileName);
